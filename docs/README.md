...
features:
  ...
  - title: 四协议内核
    details: Xray、Trojan-Go、Hysteria2、NaiveProxy 统一纳管，配置模板化、进程自托管。
  - title: 极简依赖
...
Shadow Panel 是对 Trojan Panel 的轻量化重写。支持 Xray / Trojan-Go / Hysteria / NaiveProxy，并**原生支持 socks/https 上游与 dialer-proxy 链式代理**—— 让你能直接对接 IP 代理站提供的节点。

支持协议：`Xray` `Trojan-Go` `Hysteria2` `NaiveProxy`
